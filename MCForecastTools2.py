...
class MCSimulation2:
    ...
    def calc_cumulative_return(self):
        ...
        last_prices = self.portfolio_data.xs('daily_return',level=1,axis=1)[-1:].values.tolist()[0]
        ...
        for n in range(self.nSim):
            ...
            for s in range(1,len(last_prices)):
    ...
    def plot_simulation(self):
        ...
        return self.simulated_return.hvplot(legend=False)
    ...
    def plot_distribution(self):
        ...
        plt = self.simulated_return.iloc[-1, :].hvplot(kind='hist', bins=20)
        return plt
